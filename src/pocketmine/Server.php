...
§e###################################################  §6------------------------------------------");
    ...
    public function isExtensionInstalled($type)
    {
         ...
         */
        public
        function broadcastMessage($message, $recipients = null): int
        {
         ...
         */
        public
        function broadcastTip(string $tip, $recipients = null): int
        {
            if (!is_array($recipients)) {
                /** @var Player[] $recipients */
                $recipients = [];
         ...
         */
        public
        function broadcastPopup(string $popup, $recipients = null): int
        {
            if (!is_array($recipients)) {
                /** @var Player[] $recipients */
                $recipients = [];
         ...
         */
        public
        function broadcast($message, string $permissions): int
        {
         ...
         */
        public
        function broadcastPacket(array $players, DataPacket $packet)
        {
            $packet->encode();
         ...
         */
        public
        function broadcastActionBar(string $action, $recipients = null, $win = false): int
        {
            if (!is_array($recipients)) {
                /** @var Player[] $recipients */
                $recipients = [];
